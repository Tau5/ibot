exports.execute = async (client, ctx) => {
  ...
  request(`https://api.apixu.com/v1/forecast.json?key=${client.config.api.weather}&q=${location}&lang=${locale}&hour=${require('moment-timezone')().tz(timezone).format('HH')}`, (err, http, body) => {
    ...
    const embed = new MessageEmbed()
      ...
      .addField(client.I18n.translate`Daytime`, client.I18n.translate`**Sunrise:** ${content.forecast.forecastday[0].astro.sunrise} - **Sunset:** ${content.forecast.forecastday[0].astro.sunset}`, true)
