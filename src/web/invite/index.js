module.exports = (client) => {
  ...
  router.use('/:id', (req, res) => {
    res.redirect(`https://discordapp.com/oauth2/authorize?&client_id=305277118105911296&scope=bot&guild_id=${req.params.id}&response_type=code&redirect_uri=http%3A%2F%2Fibot-discord.cf%3A9024%2Fserver`);
  });
